'''
    ...
    Terminologies
    -   main/target image denotes the image of which the photomosaic is to be made
    -   individual/filler images represents the smaller images that fit together to form the big picture
    -   every image used in this project is RGB color image, no grayscale image is used
'''
...
def split_main_image():
    ...
    img = cv2.imread(args.images, 1) #load the colour image
